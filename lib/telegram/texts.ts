...
export function welcomeText(name: string): string {
  ...
  return [
    ...
    '',
    'Что буду присылать:',
    '• старт прогулки — с кнопкой «Это не я», если стартовали за тебя',
    '• финиш: километры, серия, достижения',
    '• напоминание, если дорожка заскучала (только в рабочие дни)',
...
export function helpText(): string {
  return [
    ...
    '',
    'Всё остальное — старт, финиш, рейтинг — живёт в приложении CitrusWalk.',
  ].join('\n');
}
