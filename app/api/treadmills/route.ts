...
/**
 * GET /api/treadmills — active treadmills with current occupancy.
 ...
 * freed treadmill must not linger as busy.
 */
...
/** POST /api/treadmills — create a treadmill from the settings screen. */
