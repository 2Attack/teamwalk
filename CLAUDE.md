...
**Язык:** интерфейс (UI-тексты) — русский; комментарии в коде и сообщения коммитов — **только английский**; типы и имена — английские. Существующие русские комментарии переводить на английский при ближайшем редактировании файла.
